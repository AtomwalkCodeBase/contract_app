...
`,$u=e=>{let t=(0,al.c)(39),{sidebarWidth:n,onMobileMenuClick:r}=e,i=n===void 0?`250px`:n,{logout:a,profile:o}=nl(),[s,c]=(0,v.useState)(!1),l=ze(),u;t[0]===a?u=t[1]:(u=()=>{a()},t[0]=a,t[1]=u);let d=u,f;t[2]===l?f=t[3]:(f=()=>{l(`/profile`)},t[2]=l,t[3]=f);let p=f,m;t[4]===Symbol.for(`react.memo_cache_sentinel`)?(m=()=>{c(!1)},t[4]=m):m=t[4];let h=m,g;t[5]===Symbol.for(`react.memo_cache_sentinel`)?(g=()=>{c(!0)},t[5]=g):g=t[5];let _=g,y;t[6]===Symbol.for(`react.memo_cache_sentinel`)?(y={display:`flex`,alignItems:`center`},t[6]=y):y=t[6];let b;t[7]===Symbol.for(`react.memo_cache_sentinel`)?(b=(0,K.jsx)(uu,{}),t[7]=b):b=t[7];let x;t[8]===r?x=t[9]:(x=(0,K.jsx)(Zu,{onClick:r,children:b}),t[8]=r,t[9]=x);let S;t[10]===Symbol.for(`react.memo_cache_sentinel`)?(S={width:`50px`,height:`50px`,borderRadius:`10px`,marginRight:`10px`,border:`0.2px solid #000`},t[10]=S):S=t[10];let C;t[11]===o.image?C=t[12]:(C=(0,K.jsx)(`img`,{src:o.image,alt:`Company Logo`,style:S}),t[11]=o.image,t[12]=C);let w;t[13]!==C||t[14]!==x?(w=(0,K.jsxs)(`div`,{style:y,children:[x,C]}),t[13]=C,t[14]=x,t[15]=w):w=t[15];let T;t[16]===o.name?T=t[17]:(T=o?.name?.charAt(0)||(0,K.jsx)(Dl,{}),t[16]=o.name,t[17]=T);let E;t[18]===T?E=t[19]:(E=(0,K.jsx)(Yu,{children:T}),t[18]=T,t[19]=E);let D=o?.name||`User`,O;t[20]===D?O=t[21]:(O=(0,K.jsx)(Xu,{children:D}),t[20]=D,t[21]=O);let k;t[22]!==p||t[23]!==E||t[24]!==O?(k=(0,K.jsxs)(Ju,{onClick:p,children:[E,O]}),t[22]=p,t[23]=E,t[24]=O,t[25]=k):k=t[25];let A;t[26]===Symbol.for(`react.memo_cache_sentinel`)?(A=(0,K.jsx)(Qu,{onClick:_,title:`Logout`,children:(0,K.jsx)(Ul,{})}),t[26]=A):A=t[26];let j;t[27]===k?j=t[28]:(j=(0,K.jsxs)(Ku,{children:[k,A]}),t[27]=k,t[28]=j);let M;t[29]===d?M=t[30]:(M=()=>d(),t[29]=d,t[30]=M);let N;t[31]!==s||t[32]!==M?(N=(0,K.jsx)(Wu,{isOpen:s,onClose:h,onConfirm:M,title:`Logout`,message:`Are you sure you want to logout?`,confirmLabel:`Logout`}),t[31]=s,t[32]=M,t[33]=N):N=t[33];let ee;return t[34]!==i||t[35]!==w||t[36]!==j||t[37]!==N?(ee=(0,K.jsxs)(Gu,{sidebarWidth:i,children:[w,j,N]}),t[34]=i,t[35]=w,t[36]=j,t[37]=N,t[38]=ee):ee=t[38],ee},ed=z.div`
  display: flex;
  min-height: 100vh;
`,td=z.main`
  flex: 1;
...
`,z.a`
  ...
  &:hover {
    text-decoration: underline;
  }`;var jp=()=>{let e=(0,al.c)(33),t;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t={mobile:``,password:``,company:``},e[0]=t):t=e[0];let[n,r]=(0,v.useState)(t),[i,a]=(0,v.useState)(!1),o;e[1]===Symbol.for(`react.memo_cache_sentinel`)?(o=[],e[1]=o):o=e[1];let[,s]=(0,v.useState)(o),[c]=(0,v.useState)(`Mobile Number`),{customerlogin:l}=nl(),u=window.location.pathname,d,f;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(d=()=>{(async()=>{let e=await Jc();if(e.status===200)if(u===`/retainer/login`){let t=e.data?.filter(Mp);s(t),t.length>0&&(r(e=>({...e,company:t[0].name})),localStorage.setItem(`dbName`,t[0].name.split(`_`).slice(1).join(`_`)))}else s(e.data)})()},f=[],e[2]=d,e[3]=f):(d=e[2],f=e[3]),(0,v.useEffect)(d,f);let p;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(p=e=>{let{name:t,value:n}=e.target;r(e=>({...e,[t]:n}))},e[4]=p):p=e[4];let m=p,h;e[5]!==l||e[6]!==n.company||e[7]!==n.mobile||e[8]!==n.password?(h=async e=>{e.preventDefault(),a(!0),setTimeout(async()=>{n.mobile&&n.password?await l({id:`1`,name:`Ashutosh Mohapatra`,mobile:n.mobile,password:n.password,role:`HR Manager`,company:n?.company?.split(`_`).slice(1).join(`_`)||`Acme Inc.`}):V.error(`Invalid credentials. Please try again.`),a(!1)},500)},e[5]=l,e[6]=n.company,e[7]=n.mobile,e[8]=n.password,e[9]=h):h=e[9];let g=h,_;e[10]===Symbol.for(`react.memo_cache_sentinel`)?(_=(0,K.jsx)(vp,{children:(0,K.jsxs)(yp,{children:[(0,K.jsx)(bp,{children:`Welcome to Atomwalk`}),(0,K.jsx)(xp,{children:`A comprehensive retainer and associate employee management portal.`})]})}),e[10]=_):_=e[10];let y;e[11]===Symbol.for(`react.memo_cache_sentinel`)?(y=(0,K.jsx)(wp,{children:`Login to your account`}),e[11]=y):y=e[11];let b;e[12]===c?b=e[13]:(b=(0,K.jsx)(Ep,{htmlFor:`mobile`,children:c}),e[12]=c,e[13]=b);let x;e[14]===Symbol.for(`react.memo_cache_sentinel`)?(x=(0,K.jsx)(Op,{children:(0,K.jsx)(Dl,{})}),e[14]=x):x=e[14];let S=`Enter your `+c,C;e[15]!==n.mobile||e[16]!==S?(C=(0,K.jsxs)(Dp,{children:[x,(0,K.jsx)(kp,{type:`text`,id:`mobile`,name:`mobile`,placeholder:S,value:n.mobile,onChange:m,required:!0})]}),e[15]=n.mobile,e[16]=S,e[17]=C):C=e[17];let w;e[18]!==C||e[19]!==b?(w=(0,K.jsxs)(Tp,{children:[b,C]}),e[18]=C,e[19]=b,e[20]=w):w=e[20];let T;e[21]===Symbol.for(`react.memo_cache_sentinel`)?(T=(0,K.jsx)(Ep,{htmlFor:`password`,children:`Pin`}),e[21]=T):T=e[21];let E;e[22]===Symbol.for(`react.memo_cache_sentinel`)?(E=(0,K.jsx)(Op,{children:(0,K.jsx)(Ql,{})}),e[22]=E):E=e[22];let D;e[23]===n.password?D=e[24]:(D=(0,K.jsxs)(Tp,{children:[T,(0,K.jsxs)(Dp,{children:[E,(0,K.jsx)(kp,{type:`password`,id:`password`,name:`password`,placeholder:`Enter your pin`,value:n.password,onChange:m,required:!0})]})]}),e[23]=n.password,e[24]=D);let O=i?`Logging in...`:`Login`,k;e[25]!==i||e[26]!==O?(k=(0,K.jsx)(Ap,{type:`submit`,disabled:i,children:O}),e[25]=i,e[26]=O,e[27]=k):k=e[27];let A;return e[28]!==g||e[29]!==w||e[30]!==D||e[31]!==k?(A=(0,K.jsxs)(_p,{children:[_,(0,K.jsx)(Sp,{children:(0,K.jsxs)(Cp,{onSubmit:g,children:[y,w,D,k]})})]}),e[28]=g,e[29]=w,e[30]=D,e[31]=k,e[32]=A):A=e[32],A};function Mp(e){return e.ref_cust_name===`DEMO Allocation Project Management (Atomwalk)`}async function Np(){try{let e=localStorage.getItem(`cust_emp_id`),t={};return e&&(t.emp_id=e),Uc(zc,t)}catch(e){throw console.error(`Error fetching profile info:`,e),e}}var Pp=z.div`
